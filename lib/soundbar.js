 ...
 *
 * Formerly published as the separate npm module `lg-soundbar`. The `log` option takes any object
 * with debug()/warn() (the adapter passes the core logger).
 */
 ...
 */
export class LgSoundbar extends EventEmitter {
